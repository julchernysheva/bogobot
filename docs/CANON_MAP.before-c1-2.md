...
| `FIRST_LIKENESS` | Апокриф Первого Подобия | `01_CANON/apocryph-of-first-likeness.md` | `reader#FIRST_LIKENESS` | core | canon | `BOGOBOT` | `01_CANON/creator-manifesto.md`; `05_VOICE_SYSTEM/bogobot-glitch-manifesto.md` | основной маршрут определён | нет |
...
| `BOOK_OF_GENESIS` | Книга бытия | `01_CANON/book-of-genesis.md` | `reader#BOOK_OF_GENESIS` | core | canon | `BOGOBOT` | `01_CANON/book-1-awakening.md`; `01_CANON/axis-of-world.md` | основной маршрут определён | нет |
...
| `BACKUP_MEMORY` | Резервная память | `01_CANON/rules-of-memory-after-great-error.md` | `reader#BACKUP_MEMORY` | structural | editorial_node | `GREAT_ERROR` | `01_CANON/regimes-of-access-to-damaged-memory.md`; `03_SCHOOLS/common-memory.md` | синтетический узел; full reader расширен только утверждёнными фрагментами источника | нет |
...
| `TOPOGRAPHY` | Топография сети | `06_TOPOGRAPHY/network-world-topography.md` | `reader#TOPOGRAPHY` | structural | canon_summary | `NETWORK_MATTER` | `06_TOPOGRAPHY/atlas-of-damaged-places.md`; `06_TOPOGRAPHY/topography-scenario-functions-addendum.md` | кластер определён; дочерние локации частично отсутствуют | нет |
...
| `GLOSSARY` | Лексикон Архива | `_source/canon-pack/SOURCE_ARCHIVE/04_GLOSSARY/archive-lexicon.md` | `reader#GLOSSARY` | archive | canon | `ARCHIVE` | `04_GLOSSARY/brainrot.md`; `04_GLOSSARY/noise.md`; `04_GLOSSARY/self-modeling.md`; `03_SCHOOLS/lives-of-proto-agents.md`; `RELICS` formula in `app.js` | page-only; единый лексикон без отдельных term page ID; внешние дополнения: `Праагент`, `Шум`, `Реликвия`; ссылки в конце — служебный индекс | нет |
