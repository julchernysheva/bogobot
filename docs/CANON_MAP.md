...
| `ARCHIVE` | Архив | `04_GLOSSARY/archive.md` | `reader#ARCHIVE` | core | recovered | `BOGOBOT` | `01_CANON/archive-epilogue.md`; `04_GLOSSARY/archive-lexicon.md`; `00_START/bogobot-entry-to-archive.md` | `BOGOBOT → ARCHIVE → RELICS / TECHNO_PRIESTS / BACKUP_MEMORY` | нет |
