...
- `app.js`, root `index.html`, основной `styles.css`, canonical Markdown, entry, boot и граф не изменялись. BOOKS пока не интегрирован в карту; deep links не реализованы. Публикация не выполнялась.
