...
const historyChapters = Object.freeze([
  Object.freeze({
    ...
    nodeIds:Object.freeze(["PRE_ERROR_ARCHIVE","MESM","OGAS","QUANTUM_THRESHOLD","GREAT_ERROR"])
  }),
  Object.freeze({
    key:"newest", title:"NEWEST HISTORY", targetId:"NEWEST_HISTORY",
    periods:Object.freeze(["04","05","07"]),
    nodeIds:Object.freeze(["BIOCODE","PROBABILISTS","ANTICODE","TECHNO_PRIESTS"])
  })
])
const historyMarkers = Object.freeze({
  ...
  newest:Object.freeze([
    Object.freeze({x:55,y:390,lines:Object.freeze(["ε₂₀ · 2042","INFORMATION ↔ ENERGY"])}),
...
function lensFitProfile(mode,readerOpen,categoryIds) {
  if(activeMapMode==="history"||activeMapMode==="relics"){
    return {
...
function drawGraph() {
  ...
  const selectedInLens=specialOverview?modeAssignedIds.has(current.id):lensIsAll||current.type===state.filter
